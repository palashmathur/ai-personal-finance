...
// Modal dialog built on Radix Dialog (handles focus trap, ESC, scroll lock,
// aria roles). We add the overlay/animation styling and a close button. Used for
// the Add/Edit transaction form and the Add Trade form.
