...
// Confirmation dialog (Radix AlertDialog). Difference from Dialog: it's a
// role="alertdialog" with required Action/Cancel — used for destructive confirms
// like "Delete this transaction?". There's no X-to-dismiss; you must choose.
